export function color(string, code) {
    return `${code}${string}${colorCodes.reset}`;
}
export function colorBasic(string, color) {
 ...
 */
export function colorCodeFromSGR(code) {
    return `\x1b[${code}m`;
}
export function alternativeFont(code) {
 ...
 */
export function foregroundColor(r, g, b) {
 ...
 * @param b The blue value of the color.
 */
export function backgroundColor(r, g, b) {
 ...
 * @param b The blue value of the color.
 */
export function underlineColor(r, g, b) {
